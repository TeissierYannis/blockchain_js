...
const {MINING_REWARD, REWARD_INPUT} = require("../../config/config");
        ...
        describe('update()', () => {
            ...
            describe('and the amount is invalid', () => {
                it('throws an error', () => {
                    expect(() => {
                        transaction.update({
                            senderWallet, recipient: 'test', amount: 9999999
                        })
            ...
            describe('and the amount is valid', () => {
                ...
                it('subtracts the amount from the senders output', () => {
                    expect(transaction.outputMap[senderWallet.publicKey])
                ...
                describe('and another update is made for the same recipient', () => {
                    let addedAmount;
